...
@st.cache_resource
def load_model():
    return tf.keras.models.load_model("model_fold5.h5")
...
def understand_question(question):
    ...
    common_words = [
        ...
        'doctor', 'specialist', 'hospital', 'home', 'remedy', 'breastfeed', 'nursing'
    ]
...
def generate_response(question_type, prediction_label, confidence, corrected_question, corrections_made):
    ...
    if question_type == 'color_analysis':
      ...
      return response, False
        ...
        response += "• Can potentially cure sickle cell disease completely\n• Success rate is quite high when a good donor is found\n• However, it's not suitable for everyone\n• Requires a compatible donor (often a sibling)\n• Has risks and complications\n• Best results in younger patients (under 16)\n\n"
